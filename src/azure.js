...
module.exports = function (context, req) {
    ...
    resposta = processar(inicio,fim,textoEmbaralhado);

    context.res = {};
    context.res.body = {};
    context.res.body.resposta = resposta;
    context.res.body.tempo = (new Date().getTime() - tempoInicio);
